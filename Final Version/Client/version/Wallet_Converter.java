...
public class Wallet_Converter extends javax.swing.JFrame {
    ...
    private void CONFIRM_FLDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CONFIRM_FLDMouseClicked
        try {
            ...
            int valid= Logic.functions.WalletValidation(CARDNUMBER_FLD.getText(), NAME_FLD.getText(), YEAR.getText(), MONTH.getText(), DAY.getText(), CVV_FLD.getText(), DEPOSITE_FLD.getText());
            if(valid==-1)
            {
            ...
            {
                JOptionPane.showMessageDialog(this, "Transaction refused");
            }
            else if(valid==1)
            {
                JOptionPane.showMessageDialog(this, "Transaction accepted");
            ...
            Logger.getLogger(Wallet_Converter.class.getName()).log(Level.SEVERE, null, ex);
