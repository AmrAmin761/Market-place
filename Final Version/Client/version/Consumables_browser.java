 ...
 * @author user
 */
public class Consumables_browser extends javax.swing.JFrame {

    /**
     * Creates new form Consumables_browser
     */
    public Consumables_browser() throws SQLException, IOException, ClassNotFoundException, InterruptedException {
        initComponents();
        
    String[] columns={"Item ID","Item name","production date","price","Image"};
    Object[][] rows={};
    ...
    public Class<?> getColumnClass(int column) {
        ...
        Logic.functions.RetrieveConsumbales();
        Logic.functions.RetrieveConsIcon();
        Logic.functions.fill_Consumbales_table(jTable1, ClientVersion.b.getCons());
        QTY.setText("0");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consumables browser");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "name", "production date", "price", "Image"
            }
        ) {
    ...
    private void ACC_INFO7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ACC_INFO7MouseClicked
        try {
            ...
            Logger.getLogger(Consumables_browser.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        Logic.functions.added_items_cons(jTable1, QTY);
    ...
    private void ADDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ADDMouseClicked
        ...
        int max=Logic.functions.getMaxAmountCons(jTable1, ClientVersion.b.getItems());
    ...
    private void SEARCH_BTNMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SEARCH_BTNMouseClicked
        ...
        try {
            ...
            Logic.functions.Search_In_Consumbales(jTable1, ClientVersion.b.getCons(), SEARCHBAR.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consumables_browser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
