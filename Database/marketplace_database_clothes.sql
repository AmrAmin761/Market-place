...
CREATE TABLE `clothes` (
  ...
  PRIMARY KEY (`ClotheID`),
  UNIQUE KEY `ClotheID` (`ClotheID`),
  CONSTRAINT `clothes_ibfk_1` FOREIGN KEY (`ClotheID`) REFERENCES `item` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `clothes` VALUES (4,'XL','MALE',NULL,NULL),(5,'M','FEMALE',NULL,NULL),(6,'S','FEMALE',NULL,NULL);
