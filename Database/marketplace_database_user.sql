...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `person` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `user` VALUES (3,'01097001880','alyafif@gmail.com'),(7,'07775000','tester@gmail.com'),(8,'07775000','tester2@gmail.com');
