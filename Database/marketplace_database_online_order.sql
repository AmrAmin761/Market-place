...
CREATE TABLE `online_order` (
  ...
  KEY `UserID` (`UserID`),
  CONSTRAINT `online_order_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `operation` (`ID`),
  CONSTRAINT `online_order_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`)
...
INSERT INTO `online_order` VALUES (1,'El rehab',3);
